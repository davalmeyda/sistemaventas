...
class ConfigBloque extends Component {
    state = {
        abrir: 'ui-theme-settings',
    }
    // ABRIR PANEL DE CONFIGURACION
    abrir = () => {
        if(this.state.abrir === 'ui-theme-settings settings-open'){
            this.setState({
                abrir: 'ui-theme-settings',
            });
        }else{
            this.setState({
                abrir: 'ui-theme-settings settings-open',
            });
        }
    }
    ...
    render() {
        return (
            <div className={this.state.abrir}>
                <button onClick={this.abrir} type="button" id="TooltipDemo" className="btn-open-options btn btn-warning">
